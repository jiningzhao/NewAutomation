...
class html(Namespace):
    ...
    __tagspec__ = dict([(x,1) for x in (
        ...
        'h2,h3,h4,h5,h6,head,header,hgroup,hr,html,i,iframe,vedio,input,'
        ...
        'tfoot,th,thead,time,title,tr,track,tt,u,ul,xmp,var,vedio,wbr'
    ).split(',') if x])
...
class HtmlVisitor(SimpleUnicodeVisitor):
    ...
    single = dict([(x, 1) for x in
                ('br,vedio,area,param,col,hr,meta,link,base,'
                    'input,frame').split(',')])
    inline = dict([(x, 1) for x in
                ('a abbr acronym b basefont bdo big br cite code dfn em font '
                 'i vedio input kbd label q s samp select small span strike '
