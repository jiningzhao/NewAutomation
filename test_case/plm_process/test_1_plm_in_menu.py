...
class TestPlmMenu:
    ...
    def test_0(self, chrome_config):
        ...
        # 等待元素出现
        self.wait_element(driver, png_name="菜单加载异常", classname='el-menu-item')

    @pytest.mark.smoke
    # 跳转到运营中心页面
    def test_1(self, chrome_config):
        driver = chrome_config['driver']
        self.wait_element(driver, png_name="运营中心菜单项未找到", classname='el-menu-item')
        ...
        self.wait_element(driver, png_name="运营中心页面菜单加载超时", classname='el-menu-item')
        # driver.get_screenshot_as_file(
    ...
    def test_2(self, chrome_config):
        driver = chrome_config['driver']
        self.wait_element(driver, png_name="运营方案管理页面", classname='el-menu-item')
