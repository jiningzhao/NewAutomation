...
class TestSetPlmForNewProduct:
    ...
    def test_3(self, chrome_config):
        ...
        self.wait_element_clickable(driver, png_name="收益管理方案输入框",
                                    xpath_str="//span[contains(text(),'配置运营方案')]")
        driver.find_elements_by_xpath('//input[@placeholder="请选择"]')[1].click()
        # 选择收益管理方案
        driver.switch_to.default_content()
        self.wait_element(driver, png_name="选择收益管理方案",
                          xpath_str="//span[contains(text(),\'{}\')]".format(chrome_config['repayment_name']))
        driver.execute_script("arguments[0].click()",
        ...
        driver.find_element_by_xpath("//span[contains(text(),'配置运营方案')]").click()
        time.sleep(1)
        # 选择额度管理方案
        ...
        self.wait_element_clickable(driver, png_name="计算参数方案输入框",
                                    xpath_str="//div[contains(text(),'计算参数方案')]")
        driver.find_elements_by_xpath("//input[@placeholder='请选择']")[-1].click()
        # 选择计算参数方案
        driver.switch_to.default_content()
    ...
    def test_5(self, chrome_config):
        ...
        self.wait_element(driver, png_name="额度——编辑",
                          xpath_str='//*/section/section/section[2]/div[1]/div[2]/div/button')

        driver.execute_script("arguments[0].scrollIntoView(false);",
                              driver.find_element_by_xpath(
                                  '//*/section/section/section[2]/div[1]/div[2]/div/button'))
        self.wait_element(driver, png_name="滚动到额度——编辑按钮位置",
                          xpath_str='//*/section/section/section[2]/div[1]/div[2]/div/button')
        # 点击额度编辑
        self.wait_element_clickable(driver, png_name="额度——编辑",
                                    xpath_str="//*/section/section/section[2]/div[1]/div[2]/div/button/span")
    ...
    def test_6(self, chrome_config):
        ...
        self.wait_element(driver, png_name="贴息——编辑",
