...
class TestSetPlmForNewProduct:
    ...
    def test_3(self, chrome_config):
        ...
        # 点击确定
        self.wait_element_clickable(driver, xpath_str="//section[contains(text(),'确定')]")
    ...
    def test_4(self, chrome_config):
        ...
        # --------------------------添加业绩比较基准------------------------
        self.wait_element_clickable(driver, xpath_str="//a[text()='添加业绩比较基准']")
        # driver.find_element_by_xpath("//a[text()='添加业绩比较基准']").click()
        driver.execute_script("arguments[0].click()",
                              driver.find_element_by_xpath("//a[text()='添加业绩比较基准']"))
        self.wait_element_clickable(driver, xpath_str="//input[@placeholder='请输入认购区间']")
        ...
        # --------------------------点击确认------------------------
        self.wait_element_clickable(driver, xpath_str="//section[contains(text(),'确认')]")
        driver.find_element_by_xpath("//section[contains(text(),'确认')]").click()
        # --------------------------选择可提前赎回------------------------
        self.wait_element_clickable(driver, xpath_str='//span[contains(text(),"是")]')
        driver.find_element_by_xpath(
    ...
    def test_5(self, chrome_config):
        ...
        self.wait_element(driver, xpath_str='//*/section/section/section[2]/div[1]/div[2]/div/button')
        # 点击额度编辑
        self.wait_element_clickable(driver, xpath_str="//*/section/section/section[2]/div[1]/div[2]/div/button/span")
